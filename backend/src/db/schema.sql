...
CREATE TABLE users (
  ...
  lifestyle_score           JSONB,       -- {morning_person: 8, social: 3, pets_ok: 1}
...
CREATE TABLE listings (
  ...
  region          VARCHAR(100),           -- e.g. 'Greater Boston'
  ...
  helper_exchange BOOLEAN DEFAULT FALSE, -- open to rent reduction for household help
