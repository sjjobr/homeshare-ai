 ...
 * Messaging routes for connected matches.
 */
...
// GET /api/messages - get all conversations with last message + unread count
...
router.post('/', auth, async (req, res) => {
  try {
    ...
    // Touch the match updated_at so conversations sort properly
